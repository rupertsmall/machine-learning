...
# forward propagation for digit recognition neural network

from numpy import *

def neural_forward_multithreaded(xi, input, A_queue, MEGA_THETA, testfor):
	...
	zero2nine[testfor] = a[0]
	A_queue.put(zero2nine)
	A_queue.task_done()
